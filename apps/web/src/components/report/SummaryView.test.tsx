...
describe("SummaryView", () => {
  ...
  it("renders the column headers and at least one role section", () => {
    render(<SummaryView report={report} fightId={fightId} onPlayer={() => {}} />);
  ...
  it("navigates on player click", () => {
    ...
    render(<SummaryView report={report} fightId={fightId} onPlayer={onPlayer} />);
  ...
  it("shows a refresh notice when RPB data is missing", () => {
    ...
    render(<SummaryView report={bare} fightId={fightId} onPlayer={() => {}} />);
