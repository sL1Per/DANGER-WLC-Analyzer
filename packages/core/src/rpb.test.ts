...
const cfg: RpbConfig = {
  roles: { signals: [{ spellId: 5487, role: "tank", name: "Bear Form" }], casterClasses: ["Mage", "Warlock", "Priest", "Shaman"], physicalSpecs: ["Enhancement"], casterSpecs: ["Balance"], physicalSpecCastNames: ["Stormstrike"] },
